...
static pfIoTHubTransport_SetTransportCallbacks          IoTHubTransportHttp_SetTransportCallbacks;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    IoTHubTransportHttp_SetTransportCallbacks = ((TRANSPORT_PROVIDER*)HTTP_Protocol())->IoTHubTransport_SetTransportCallbacks;
...
TEST_FUNCTION(IoTHubTransportHttp_SetTransportCallbacks_success)
{
    // arrange
    TRANSPORT_LL_HANDLE handle = IoTHubTransportHttp_Create(&TEST_CONFIG, &transport_cb_info, transport_cb_ctx);
    umock_c_reset_all_calls();
    ...
    // act
    int result = IoTHubTransportHttp_SetTransportCallbacks(handle, &transport_cb_info, transport_cb_ctx);
...
TEST_FUNCTION(IoTHubTransportHttp_SetTransportCallbacks_fail)
{
    // arrange
    TRANSPORT_LL_HANDLE handle = IoTHubTransportHttp_Create(&TEST_CONFIG, &transport_cb_info, transport_cb_ctx);
    umock_c_reset_all_calls();
    ...
    // act
    int result = IoTHubTransportHttp_SetTransportCallbacks(handle, NULL, transport_cb_ctx);
