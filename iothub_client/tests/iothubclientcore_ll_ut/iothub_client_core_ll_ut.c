...
MOCKABLE_FUNCTION(, int, FAKE_IoTHubTransport_SetTransportCallbacks, TRANSPORT_LL_HANDLE, handle, TRANSPORT_CALLBACKS_INFO*, cb_info, void*, ctx);
...
static TRANSPORT_PROVIDER FAKE_transport_provider =
{
    ...
    FAKE_IoTHubTransport_SetTransportCallbacks
};
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(FAKE_IoTHubTransport_SetTransportCallbacks, 0)
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateWithTransport_Succeeds)
{
    ...
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Create(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetTransportCallbacks(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
