...
TEST_FUNCTION(IoTHubTransport_AMQP_SetTransportCallbacks_success)
{
    // arrange
    TRANSPORT_LL_HANDLE handle = create_transport();
    umock_c_reset_all_calls();
    ...
    // act
    int result = IoTHubTransport_AMQP_SetTransportCallbacks(handle, &transport_cb_info, transport_cb_ctx);
...
TEST_FUNCTION(IoTHubTransport_AMQP_SetTransportCallbacks_fail)
{
    // arrange
    TRANSPORT_LL_HANDLE handle = create_transport();
    umock_c_reset_all_calls();
    ...
    // act
    int result = IoTHubTransport_AMQP_SetTransportCallbacks(handle, NULL, transport_cb_ctx);
