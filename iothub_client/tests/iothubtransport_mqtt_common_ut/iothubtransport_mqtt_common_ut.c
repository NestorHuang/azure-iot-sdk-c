...
TEST_FUNCTION(IoTHubTransport_MQTT_SetTransportCallbacks_success)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME, TEST_MODULE_ID);
    ...
    // act
    int result = IoTHubTransport_MQTT_SetTransportCallbacks(handle, &transport_cb_info, transport_cb_ctx);
...
TEST_FUNCTION(IoTHubTransport_MQTT_SetTransportCallbacks_fail)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME, TEST_MODULE_ID);
    ...
    // act
    int result = IoTHubTransport_MQTT_SetTransportCallbacks(handle, NULL, transport_cb_ctx);
