    ...
    else
    {
        ...
        if (handleData->doBatchedTransfers)
        {
            ...
            else
            {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (statusCode < 300)
                                {
                                    ...
                                    handleData->transport_callbacks.send_complete_cb(&(deviceData->eventConfirmations), IOTHUB_CLIENT_CONFIRMATION_OK, handleData->transport_ctx);
                                }
                                else
                                {
                                    //items go back to waitingToSend
                ...
                {
                    handleData->transport_callbacks.send_complete_cb(&(deviceData->eventConfirmations), IOTHUB_CLIENT_CONFIRMATION_ERROR, handleData->transport_ctx); // takes care of emptying the list too
                    break;
                }
                                        ...
                                        else
                                        {
                                            ...
                                            if (r == HTTPAPIEX_OK)
                                            {
                                                if (statusCode < 300)
                                                {
                                                    ...
                                                    handleData->transport_callbacks.send_complete_cb(&(deviceData->eventConfirmations), IOTHUB_CLIENT_CONFIRMATION_OK, handleData->transport_ctx); // takes care of emptying the list too
                                                }
                                                else
                                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    bool abandon;
                                                    if (handleData->transport_callbacks.msg_cb(messageData, handleData->transport_ctx))
                                                    {
                                                        abandon = false;
                                                    }
                                                    else
